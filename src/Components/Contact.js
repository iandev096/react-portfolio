...
const Contact = ({ data }) => {
   ...
   const [emailTo, setEmailTo] = useState('iandev096@gmail.com');
   ...
   console.log(data)
    ...
    const handleClick = (e) => {
       e.preventDefault();
      window.open(`mailto:${emailTo}?subject=${subject}&body=${name}: ${message}`);
    }
         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
						   <label htmlFor="contactEmail">EmailTo <span className="required">*</span></label>
						   <input disabled value={emailTo} type="text" defaultValue="" size="35" id="contactEmail" name="contactEmail" onChange={e=> setEmailTo(e.target.value)}/>
                  </div>
